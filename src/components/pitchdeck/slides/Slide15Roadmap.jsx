...
const milestones = [
  {
    period: "1. Dönem",
    when: "Ne Zaman?",
    title: "Bu dönemde ne yapacaksınız?",
    desc: "Ürün geliştirme, ilk kullanıcı edinimi veya MVP lansmanı gibi temel hedefleri buraya ekleyin.",
    done: true,
  },
  {
    period: "2. Dönem",
    when: "Ne Zaman?",
    title: "Bu dönemde ne yapacaksınız?",
    desc: "Büyüme hızlandırma, yeni özellikler veya pazar genişlemesi. Hedef metrikleri belirtin.",
    done: true,
  },
  {
    period: "3. Dönem",
    when: "Ne Zaman?",
    title: "Bu dönemde ne yapacaksınız?",
    desc: "Yeni pazarlara giriş, ürün olgunlaşması veya büyük ortaklıklar. Somut hedefler ekleyin.",
    done: false,
  },
  {
    period: "4. Dönem",
    when: "Ne Zaman?",
    title: "Bu dönemde ne yapacaksınız?",
    desc: "Uzun vadeli vizyon: uluslararası genişleme, halka arz hazırlığı veya yeni gelir kolları.",
    done: false,
  },
];
