    ...
    <SlideWrapper>
      ...
      <div className="w-full max-w-5xl z-10 text-center">
        ...
        <motion.div
          ...
          className="mb-4"
        >
          <div className="text-8xl md:text-9xl font-black bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent">
            $XXM
          </div>
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-5 py-2 mb-12"
        >
        ...
        <div className="grid grid-cols-4 gap-4">
          {metrics.map((m, i) => (
            <motion.div
              ...
              className="bg-secondary/20 border border-border/30 rounded-2xl p-5 flex flex-col items-center gap-3 hover:scale-105 transition-transform"
            >
